const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-08-18', // 建站日期，用于计算网站运行的第几天
  ...
  HERO_TITLE_1: '分享知识',
  HERO_TITLE_2: '分享生活',
  HERO_TITLE_3: 'ILIUQI.COM',
  HERO_TITLE_4: '新版上线',
  HERO_TITLE_5: '浮光掠影',
  HERO_TITLE_LINK: 'http://iliuqi.com:9999',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '必看精选', url: '/tag/必看精选' },
  HERO_CATEGORY_2: { title: '热门文章', url: '/tag/热门文章' },
  HERO_CATEGORY_3: { title: '生活点滴', url: '/tag/生活点滴' },
  ...
  INFO_CARD_URL: 'https://github.com/miniLQ/NotionNext', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_TITLE_1: 'Discord交流频道',
  SOCIAL_CARD_TITLE_2: '加入我们的社群讨论分享',
  SOCIAL_CARD_TITLE_3: '点击加入社群',
  SOCIAL_CARD_URL: 'https://discord.com/channels/1142999348972621914/1142999348972621917',
